...
public class DogHashcode {
    ...
    public String toString() {
        return "狗狗名字：" + this.getName() + "\t主人电话号码：" + this.getPhone();
    }
    ...
    public static void main(String[] args) {
        ...
        DogHashcode doghc = new DogHashcode("旺旺", "123456");
        set.add(doghc);
        set.add(new DogHashcode("旺旺", "987654"));
        set.add(new DogHashcode("春花", "123456"));
        set.add(new DogHashcode("旺旺", "123456"));
